	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 transform1_g121 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				...
				float4 transform2_g121 = mul(GetObjectToWorldMatrix(),float4( MB_LocalPivot139 , 0.0 ));
				float2 UVs27_g115 = ( (transform1_g121).xz + (transform2_g121).xz );
				...
				float3 RotationAxis56_g119 = MB_RotationAxis138;
				...
				float4 StaticWorldNoise31_g117 = StaticNoise120;
				...
				float MB_RotationAngle140 = radians( ( ( ( ( MB_Amplitude109 + ( MB_AmplitudeOffset115 * (StaticWorldNoise31_g117).x ) ) * sin( ( ( ( transform8_g117.x + transform8_g117.z ) + ( ( ( _TimeParameters.x ) * ( MB_Frequency118 + ( MB_FrequencyOffset113 * (StaticWorldNoise31_g117).x ) ) ) + ( ( 2.0 * PI ) * PhaseShift112 ) ) ) * MB_Phase117 ) ) ) + MB_DefaultBending111 ) * ( v.vertex.xyz.y / MB_MaxHeight114 ) ) );
				float RotationAngle54_g119 = MB_RotationAngle140;
				float3 PivotPoint60_g119 = MB_LocalPivot139;
				...
				float3 rotatedValue34_g119 = RotateAroundAxis( PivotPoint60_g119, ( rotatedValue30_g119 + float3( 0,0,0 ) ), RotationAxis56_g119, RotationAngle54_g119 );
				float3 temp_output_149_0 = ( ( rotatedValue34_g119 - v.vertex.xyz ) * step( 0.01 , v.vertex.xyz.y ) );
				float3 MainBending89_g120 = temp_output_149_0;
				float3 appendResult15_g120 = (float3(0.0 , 1.0 , 0.0));
				float4 transform17_g120 = mul(GetObjectToWorldMatrix(),float4( appendResult15_g120 , 0.0 ));
				float4 break20_g120 = transform17_g120;
				float3 appendResult24_g120 = (float3(-break20_g120.z , 0.0 , break20_g120.x));
				float3 appendResult3_g120 = (float3(0.0 , 1.0 , 0.0));
				float4 transform4_g120 = mul(GetObjectToWorldMatrix(),float4( appendResult3_g120 , 0.0 ));
				float3 lerpResult84_g120 = lerp( float3(0,1,0) , (transform4_g120).xyz , step( 1E-06 , ( abs( transform4_g120.x ) + abs( transform4_g120.z ) ) ));
				float3 normalizeResult7_g120 = normalize( lerpResult84_g120 );
				float dotResult9_g120 = dot( normalizeResult7_g120 , float3(0,1,0) );
				float temp_output_12_0_g120 = acos( dotResult9_g120 );
				float NaNPrevention21_g120 = step( 0.01 , abs( ( temp_output_12_0_g120 * ( 180.0 / PI ) ) ) );
				float3 lerpResult26_g120 = lerp( float3(1,0,0) , appendResult24_g120 , NaNPrevention21_g120);
				float4 transform28_g120 = mul(GetWorldToObjectMatrix(),float4( lerpResult26_g120 , 0.0 ));
				float3 normalizeResult49_g120 = normalize( (transform28_g120).xyz );
				float3 RotationAxis30_g120 = normalizeResult49_g120;
				float SlopeCorrectionOffset150 = _SlopeCorrectionOffset;
				float SlopeCorrectionMagnitude146 = _SlopeCorrectionMagnitude;
				float RotationAngle29_g120 = ( saturate( ( (0.0 + ((StaticNoise120).x - 0.0) * (SlopeCorrectionOffset150 - 0.0) / (1.0 - 0.0)) + SlopeCorrectionMagnitude146 ) ) * temp_output_12_0_g120 );
				float3 rotatedValue35_g120 = RotateAroundAxis( MB_LocalPivot139, ( v.vertex.xyz + MainBending89_g120 ), RotationAxis30_g120, RotationAngle29_g120 );
				float3 lerpResult52_g120 = lerp( MainBending89_g120 , ( rotatedValue35_g120 - v.vertex.xyz ) , NaNPrevention21_g120);
				#ifdef _ENABLESLOPECORRECTION_ON
				float3 staticSwitch159 = lerpResult52_g120;
				#else
...
/*ASEBEGIN
Version=18600
0;72.57143;1496;810;8245.674;2341.537;4.275259;True;False
Node;AmplifyShaderEditor.CommentaryNode;91;-3964.778,517.1687;Inherit;False;885.4651;379.8646;;6;139;136;125;112;98;168;Vertex Colors and UVs Baked Data;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;125;-3906.098,744.8298;Inherit;False;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;136;-3649.771,752.2927;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NegateNode;168;-3463.601,754.1884;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;87;-4480.092,-509.5593;Inherit;False;1274.904;764.9824;;8;121;120;107;95;94;96;170;169;World Space Noise;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;139;-3279.299,747.2927;Inherit;False;MB_LocalPivot;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;88;-5625.572,-1085.55;Inherit;False;888.7255;1337.645;;25;150;146;142;141;119;118;117;115;114;113;111;110;109;108;106;105;104;103;102;101;100;99;97;93;92;Material Properties;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;169;-4438.336,-382.5807;Inherit;False;139;MB_LocalPivot;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;92;-5575.37,-433.7958;Float;False;Property;_MBWindDir;MB Wind Dir;12;0;Create;True;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;95;-4281.681,-92.24121;Inherit;False;Property;_NoiseTextureTilling;Noise Tilling - Static (XY), Animated (ZW);4;0;Create;False;0;0;False;0;False;1,1,1,1;1,1,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;96;-4201.681,96.7598;Float;False;Property;_NoisePannerSpeed;Noise Panner Speed;5;0;Create;True;0;0;False;0;False;0.05,0.03;0.08,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;97;-5575.555,-340.7338;Inherit;False;Global;MBGlobalWindDir;MB Global Wind Dir;28;1;[HideInInspector];Create;True;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;93;-5572.555,-255.7339;Inherit;False;Property;_MBWindDirBlend;MB Wind Dir Blend;14;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;170;-4233.667,-377.2617;Inherit;False;WorldSpaceUVs - NHP;-1;;121;88a2e8a391a04e241878bdb87d9283a3;0;1;6;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;94;-4229.293,-298.4453;Inherit;True;Property;_NoiseTexture;Noise Texture;3;1;[NoScaleOffset];Create;True;0;0;False;0;False;512fa11ad89d84543ad8d6c8d9cb6743;512fa11ad89d84543ad8d6c8d9cb6743;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;107;-3925.864,-180.3833;Inherit;False;WorldSpaceNoise - NHP;-1;;115;af5fa9ff24e18344ebcc05b64d296c57;0;4;22;FLOAT2;0,0;False;20;SAMPLER2D;;False;24;FLOAT4;1,1,1,1;False;19;FLOAT2;0.1,0.1;False;2;COLOR;0;COLOR;16
Node;AmplifyShaderEditor.RangedFloatNode;101;-5575.37,-546.7959;Float;False;Property;_MBPhase;MB Phase;11;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;98;-3909.618,574.7148;Inherit;False;VertexColorData - NHP;-1;;116;0242ce46c610b224e91bc03a7bf52b77;0;1;17;FLOAT;0;False;3;FLOAT3;19;FLOAT3;0;FLOAT;18
Node;AmplifyShaderEditor.RangedFloatNode;108;-5579.671,-822.4971;Float;False;Property;_MBAmplitudeOffset;MB Amplitude Offset;8;0;Create;True;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;104;-5565.738,-144.6099;Float;False;Property;_MBWindDirOffset;MB Wind Dir Offset;13;0;Create;True;0;0;False;0;False;20;0;0;180;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;105;-5579.671,-727.4971;Float;False;Property;_MBFrequency;MB Frequency;9;0;Create;True;0;0;False;0;False;1.11;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;99;-5265.555,-361.7338;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;103;-5564.916,-45.65084;Inherit;False;Property;_MBMaxHeight;MB Max Height;15;0;Create;True;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;102;-5579.671,-919.4971;Float;False;Property;_MBAmplitude;MB Amplitude;7;0;Create;True;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;100;-5579.671,-1015.496;Float;False;Property;_MBDefaultBending;MB Default Bending;6;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;106;-5577.293,-634.886;Inherit;False;Property;_MBFrequencyOffset;MB Frequency Offset;10;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;119;-5019.369,-368.3459;Float;False;MB_WindDirection;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;109;-5005.57,-919.5969;Float;False;MB_Amplitude;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;112;-3454.674,616.0168;Float;False;PhaseShift;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;111;-5037.57,-1015.596;Float;False;MB_DefaultBending;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;114;-4996.916,-44.65084;Inherit;False;MB_MaxHeight;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;118;-5005.57,-727.5969;Float;False;MB_Frequency;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;120;-3414.728,-219.0313;Inherit;False;StaticNoise;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;110;-5076.737,-144.6099;Inherit;False;MB_WindDirectionVariation;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;113;-5039.294,-634.8279;Inherit;False;MB_FrequencyOffset;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;117;-5001.27,-546.896;Inherit;False;MB_Phase;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;121;-3412.781,-103.7092;Inherit;False;AnimatedNoise;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;115;-5037.57,-823.5969;Inherit;False;MB_AmplitudeOffset;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;142;-5563.412,164.334;Inherit;False;Property;_SlopeCorrectionOffset;Slope Correction Offset;18;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;-5562.738,68.39018;Inherit;False;Property;_SlopeCorrectionMagnitude;Slope Correction Magnitude;17;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;150;-5040.564,165.343;Inherit;False;SlopeCorrectionOffset;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;146;-5066.737,68.39018;Inherit;False;SlopeCorrectionMagnitude;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;149;-1443.771,-515.7417;Inherit;False;MainBending - NHP;-1;;119;01dba1f3bc33e4b4fa301d2180819576;0;4;55;FLOAT3;0,0,0;False;53;FLOAT;0;False;59;FLOAT3;0,0,0;False;58;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;157;-986.9278,-318.2566;Inherit;False;SlopeCorrection - NHP;-1;;120;af38de3ca0adf3c4ba9b6a3dd482959e;0;5;87;FLOAT3;0,0,0;False;42;FLOAT;1;False;92;FLOAT;0;False;93;FLOAT4;0,0,0,0;False;41;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;734.345,-638.2534;Float;False;True;-1;2;LowPolyReedmace_MaterialInspector;0;2;Nicrom/NHP/ASE/Low Poly Reedmace;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=454BB426D7032EF9EBBBC2A63ED99A4FCC7C336D