	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 transform8_g100 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				...
				float MB_RotationAngle247 = radians( ( ( ( ( MB_Amplitude208 + ( MB_AmplitudeOffset214 * (StaticWorldNoise31_g100).x ) ) * sin( ( ( ( transform8_g100.x + transform8_g100.z ) + ( ( ( _TimeParameters.x ) * ( MB_Frequency219 + ( MB_FrequencyOffset213 * (StaticWorldNoise31_g100).x ) ) ) + ( ( 2.0 * PI ) * 0.0 ) ) ) * MB_Phase220 ) ) ) + MB_DefaultBending217 ) * ( v.vertex.xyz.y / MB_MaxHeight221 ) ) );
				float RotationAngle54_g101 = MB_RotationAngle247;
				float3 PivotPoint60_g101 = float3( 0,0,0 );
				float3 break62_g101 = PivotPoint60_g101;
				float3 appendResult45_g101 = (float3(break62_g101.x , v.vertex.xyz.y , break62_g101.z));
				float3 rotatedValue30_g101 = RotateAroundAxis( appendResult45_g101, v.vertex.xyz, RotationAxis56_g101, RotationAngle54_g101 );
				...
				float4 transform5_g96 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float DB_HorizontalPhase172 = _DBHorizontalPhase;
				float3 PivotPoint49_g96 = float3( 0,0,0 );
				float3 break52_g96 = PivotPoint49_g96;
				float3 appendResult20_g96 = (float3(break52_g96.x , v.vertex.xyz.y , break52_g96.z));
				float DB_HorizontalMaxRadius158 = _DBHorizontalMaxRadius;
				float3 rotatedValue33_g96 = RotateAroundAxis( PivotPoint49_g96, v.vertex.xyz, float3(0,1,0), radians( ( ( DB_HorizontalAmplitude161 * sin( ( ( ( ( _TimeParameters.x ) * Frequency41_g96 ) - ( ( 2.0 * PI ) * ( 1.0 - DB_PhaseShift171 ) ) ) + ( ( ( transform5_g96.x + transform5_g96.z ) + ( ( _TimeParameters.x ) * Frequency41_g96 ) ) * DB_HorizontalPhase172 ) ) ) ) * ( distance( v.vertex.xyz , appendResult20_g96 ) / DB_HorizontalMaxRadius158 ) ) ) );
				float3 DB_HorizontalBending202 = ( ( rotatedValue33_g96 - v.vertex.xyz ) * DetailBendingMask165 );
				...
				float3 LocalVertexOffset263 = ( ( rotatedValue34_g101 - v.vertex.xyz ) * step( 0.01 , v.vertex.xyz.y ) );
...
/*ASEBEGIN
Version=18600
0;72.57143;1460;754;4175.279;1025.512;5.268732;True;False
...
Node;AmplifyShaderEditor.FunctionNode;191;-515.5781,1819.77;Inherit;False;HorizontalBending - NHP;-1;;96;0b16e2546645f904a949bfd32be36037;0;7;44;FLOAT;1;False;39;FLOAT;1;False;43;FLOAT;1;False;40;FLOAT;0;False;46;FLOAT;2;False;47;FLOAT3;0,0,0;False;45;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;205;-2048.317,322.0015;Inherit;False;WorldSpaceNoise - NHP;-1;;97;af5fa9ff24e18344ebcc05b64d296c57;0;4;22;FLOAT2;0,0;False;20;SAMPLER2D;;False;24;FLOAT4;1,1,1,1;False;19;FLOAT2;0.1,0.1;False;2;COLOR;0;COLOR;16
...
Node;AmplifyShaderEditor.FunctionNode;258;2947.444,1331.494;Inherit;False;MainBending - NHP;-1;;101;01dba1f3bc33e4b4fa301d2180819576;0;4;55;FLOAT3;0,0,0;False;53;FLOAT;0;False;59;FLOAT3;0,0,0;False;58;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=82E8A349BE7056941625FD255BE3202CE5DA9D18